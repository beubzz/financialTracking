...
interface MoneyEntry { id: string; label: string; amount: number; recurrence: 'week' | 'month' | 'year'; section: 'mandatory' | 'pleasure' | 'variable'; }
...
export class ExpenseSectionComponent {
  ...
  readonly section = input.required<'mandatory' | 'pleasure' | 'variable'>();
